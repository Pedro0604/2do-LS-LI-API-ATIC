...
public class Reserva {
	...
	public double montoAReembolsar(LocalDate fechaCancelacion) {
		if (!fechaCancelacion.isBefore(this.periodo.getFrom())) {
			return 0.0;
		}
		return this.propiedad.porcentajeAReembolsar(fechaCancelacion, this.periodo.getFrom()) * this.calcularPrecio();
	}
}
